        ...
        <div class="flex flex-wrap xl:mx-auto xl:container">
            <div class="w-full relative lg:w-1/2 xl:mt-10 mb-10 2xl:pr-24 2xl:pl-0 xl:pl-12 pl-0">
                ...
                <div class="w-full flex flex-col items-start xl:justify-start relative z-20 xl:px-0 px-4 xl:py-0 py-4">
                    <div class="w-full 2xl:pl-48 xl:pt-1">
                        <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold tracking-wider text-gray-800">ĐỊA CHỈ</h1>
                        <div class="w-full md:w-10/12 mt-3">
                            <h2 class="text-gray-800 text-base md:text-lg leading-8 tracking-wider">Mời bạn đến cửa hàng của chúng tôi</h2>
                            <div class="mt-4 md:mt-8">
                                <h2 class="text-sm md:text-base text-indigo-700 font-semibold">Địa Chỉ</h2>
                                <h2 class="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">118B Lê Quang Đạo - P.Phú Đô - Q.Nam Từ Liêm</h2>
                            </div>
                            <div class="mt-4 md:mt-8">
                            ...
                            <div class="mt-4 md:mt-8">
                                ...
                                <h2 class="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">hoangvmph13792@fpt.edu.vn</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full lg:w-1/2 xl:pt-10 lg:pl-24">
                <div class="flex flex-col items-start xl:justify-start 2xl:justify-end xl:px-0 px-4">
                    <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold tracking-wider text-indigo-700">Liên Hệ</h1>
                    <div class="w-full 2xl:w-8/12 mt-3" role="form">
                        <h2 class="text-gray-800 text-base md:text-lg leading-8 tracking-wider">Nếu có thắc mắc, vui lòng gửi email cho chúng tôi theo mẫu dưới đây</h2>
                        <div class="mt-4 md:mt-8">
                            <p class="text-gray-800 text-base font-medium">Họ Tên</p>
                            <input class="mt-3 text-base border-2 w-11/12 lg:w-full xl:w-10/12 hover:border-indigo-600 focus:border-indigo-600 focus:outline-none border-black py-5 pl-4 text-gray-800" type="text" placeholder="Mời Nhập Họ Tên . . ." aria-label="enter your name input" />
                        </div>
                        <div class="mt-4 md:mt-8">
                            <p class="text-gray-800 text-base font-medium">Email</p>
                            <input class="mt-3 text-base border-2 w-11/12 lg:w-full xl:w-10/12 hover:border-indigo-600 focus:border-indigo-600 focus:outline-none border-black py-5 pl-4 text-gray-800" type="email" placeholder="Nhập Email . . ." aria-label="enter your email input" />
                        </div>
                        <div class="mt-4 md:mt-8">
                            <p class="text-gray-800 text-base font-medium">Nhắn tin</p>
                            <textarea class="mt-3 text-base border-2 w-11/12 lg:w-full xl:w-10/12 resize-none hover:border-indigo-600 focus:border-indigo-600 focus:outline-none border-black xl:h-40 py-5 pl-4 text-gray-800" type="text" placeholder="Nhập Tin . . ." aria-label="enter your message input"></textarea>
                        </div>
                        <div class="py-5">
